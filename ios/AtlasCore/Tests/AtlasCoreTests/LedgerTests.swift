...
final class LedgerTests: XCTestCase {
    ...
    func testGlobalAnchorChainAndLookup() throws {
        ...
        let r1 = led.root
        let rec1 = try g.anchor(ownerID: Data("user-A".utf8), root: r1, epochRound: Data([0,0,0,0,0,0,0,1]))
        led.append(LedgerCommit.commit(Data("m1".utf8)).commitment)
        let r2 = led.root
        try g.anchor(ownerID: Data("user-A".utf8), root: r2, epochRound: Data([0,0,0,0,0,0,0,2]))
    ...
    func testAccountableProvableDeniableNot() throws {
        ...
        try g.anchor(ownerID: led.ownerID, root: led.root, epochRound: Data([0,0,0,0,0,0,0,7]))
