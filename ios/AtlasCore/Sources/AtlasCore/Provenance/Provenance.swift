...
public final class ProvenanceBundle {
    ...
    init(contentHash: Data, authorshipHandle: Data, authorshipPublic: HybridSign.PublicKey,
         metadata: CaptureMetadata, epochRound: Data, epochRandomness: Data, pad: PADResult,
        ...
        self.epochRound = epochRound; self.epochRandomness = epochRandomness; self.pad = pad
    ...
    public func transcript() -> Data {
        Primitives.H(Data("atlas/provenance".utf8), contentHash, metadata.canonical(),
                     epochRound, epochRandomness, pad.digest(), liveness.poleDigest, authorshipHandle)
    }
}
...
public enum Provenance {
    ...
    /// H(label, authorship_handle, content_hash, epoch_round) — the capture binding.
    public static func captureBinding(label: Data, authorshipHandle: Data,
                                      contentHash: Data, epochRound: Data) -> Data {
        Primitives.H(label, authorshipHandle, contentHash, epochRound)
    }
    ...
    public static func signCapture(content: Data, depthMap: [Double], moireScore: Double,
        ...
        let bundle = ProvenanceBundle(contentHash: contentHash, authorshipHandle: authorship.handle,
                                      ...
                                      epochRound: beaconRound.epochRound(), epochRandomness: beaconRound.randomness,
    ...
    public static func verify(_ bundle: ProvenanceBundle, content: Data, ledger: LedgerStub,
        ...
        let livenessOK = bundle.liveness.verify() && bundle.liveness.operate && bundle.liveness.epochRound == bundle.epochRound
