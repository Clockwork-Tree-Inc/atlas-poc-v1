...
public enum Derivation {
    ...
    public static func sessionKeyCoupled(tsk: Data, devKey: Data, poleState: Data,
                                         beacon: Data, epochRound: Data) -> SessionKey {
    ...
    /// K[t+1] = HKDF( K[t] || H(entropy_t) || beacon_t || epoch_round ).
    public static func ratchet(_ prevKey: Data, entropyT: Data, beaconT: Data, epochRound: Data) -> Data {
        Primitives.hkdfCombine([prevKey, Primitives.H(entropyT), beaconT, epochRound],
