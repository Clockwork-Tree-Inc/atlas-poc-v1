...
public func poleFromAmbient(_ source: SignalSource, ticks: Int, epochRound: Data,
    ...
    return gate.state(sensorDigest: sensorDigest, epochRound: epochRound)
}
...
public func timedRatchetStep(device: Device, source: SignalSource, pole: PoLEState,
                             epochRound: Data, beacon: Data, challenge: Data = Data()) throws -> TimedTick {
    ...
    let tick = try device.continuityTick(pole, epochRound: epochRound, beacon: beacon, challenge: challenge)
