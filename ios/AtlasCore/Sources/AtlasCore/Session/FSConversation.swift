...
public enum FSConversation {
    ...
    public static func seedChain(channelKey: Data, lk: Data, epochRound: Data, direction: Data) -> Data {
        Primitives.hkdfCombine([channelKey, lk, epochRound, direction], info: chainInfo, length: 32)
    }
    ...
    static func step(_ chainKey: Data, beaconT: Data, epochRound: Data) -> (mk: Data, ck: Data) {
        let mk = Primitives.hkdfCombine([chainKey, Data("mk".utf8), beaconT, epochRound], info: chainInfo, length: 32)
        let ck = Primitives.hkdfCombine([chainKey, Data("ck".utf8), beaconT, epochRound], info: chainInfo, length: 32)
        return (mk, ck)
    }
}
...
public final class FSChain {
    private var ck: Data
    private let epochRound: Data

    public init(seed: Data, epochRound: Data) {
        self.ck = seed
