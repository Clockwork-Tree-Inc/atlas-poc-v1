...
public enum Unlinkability {
    /// epoch_pseudonym = Derive(child secret, epoch_round): fresh per epoch,
    ...
    /// accountability.
    public static func epochPseudonym(childSecret: Data, epochRound: Data) -> Data {
        Primitives.H(Data("atlas/epoch-pseudonym".utf8), childSecret, epochRound)
    }
}
