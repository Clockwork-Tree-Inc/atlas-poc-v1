...
public enum Primitives {
    ...
    /// The clean-value source. HONEST NAMING: OS CSPRNG (`SecRandomCopyBytes`) seeded by the
    /// Secure Enclave's hardware TRNG — strong and unpredictable, but NOT quantum. "QRNG"
    /// throughout names the clean-value seam/role; a real quantum source drops in behind it later.
    /// Today: CSPRNG-over-hardware-TRNG (QRNG-ready).
