...
not trivially linkable across epochs:
    ...
    epoch_pseudonym = Derive(child, epoch_round)   — fresh per epoch
...
def epoch_pseudonym(child: Child, epoch_round: bytes) -> bytes:
    ...
    return H(b"atlas/epoch-pseudonym", secret, epoch_round)
