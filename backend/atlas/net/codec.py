...
def bundle_to_json(b: ProvenanceBundle) -> dict:
    return {
        ...
        "liveness": {
            "epoch_round": _b(b.liveness.epoch_round),
...
def bundle_from_json(d: dict) -> ProvenanceBundle:
    ...
    return ProvenanceBundle(
        ...
        liveness=LivenessAttestation(
            epoch_round=_u(lv["epoch_round"]), pole_digest=_u(lv["pole_digest"]), operate=lv["operate"],
