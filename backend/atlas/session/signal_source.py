...
def pole_from_ambient(source: SignalSource, *, ticks: int, epoch_round: bytes,
...
def timed_ratchet_step(device, source: SignalSource, *, pole, epoch_round: bytes,
    ...
    tick = device.continuity_tick(pole, epoch_round=epoch_round, beacon=beacon,
                                  challenge=challenge)
